...
func progressUpdate (steps: Int, goal: Int) {
    let stepsGoal :Int = steps * 100 / goal
    if stepsGoal < 10 {
        print("You're off to a good start.")
    }
    else if stepsGoal < 50 {
        print("You're almost halfway there!")
    }
    else if stepsGoal < 90 {
        print("You're over halfway there!")
    }
    else if stepsGoal < 100 {
...
func pacing (currentDistance:Double, totalDistance:Double, currentTime:Double, goalTime:Double) {
    if (currentDistance * 100 / totalDistance) < (currentTime * 100 / goalTime) {
...
pacing(currentDistance: 200, totalDistance: 1000, currentTime: 120, goalTime: 300)
