...
var favoriteBook = Book (title: "American Psycho", author: "Bret Easton Ellis", pages: 399, price: 19.99)
...
print(someonesHeight.heightInCentimeters, someonesHeight.heightInInches)
/*:
