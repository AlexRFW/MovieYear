 ...
 */
var alex = User (name: "Alex Witkamp", age: 26, height: 187, weight: 70, activityLevel: 10)

print(alex.name, alex.age, alex.height, alex.weight, alex.activityLevel)
/*:
...
print(mile.meters, mile.feet)
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var meter = Distance (feet: 33)

print(meter.meters, meter.feet)
