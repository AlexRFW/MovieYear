...
struct User {
    ...
    static var currentUser:User = User (userName: "alexwitkamp", email: "alexwitkamp@gmail.com", age: 26)
...
print(currentUser.userName, currentUser.email, currentUser.age)
...
var user2 = User(userName: "piet", email: "piet@gmail.com", age: 41)
