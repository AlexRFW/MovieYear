...
//It wouldn't work as A) falcon is on the previous page, and B) Falcon is not a Fighter but Spaceship only so it has no weapon and remainingFirePower variables.
/*:
